      ...
      <div className="mx-12 max-w-full py-12 px-4 sm:px-6 lg:px-8 lg:py-24">
        <div className="space-y-12">
          <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Equipo</h2>
            <p className="text-xl text-gray-500 max-w-5xl">

              Nuestro equipo de construcción de la web app está formado por profesionales apasionados y altamente capacitados, comprometidos en ofrecerte una experiencia excepcional.
            </p>
          </div>
          <ul
            role="list"
