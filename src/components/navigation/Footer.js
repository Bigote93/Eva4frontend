...
const navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.linkedin.com/in/diego-nalli-garcia/',
      icon: (props) => (
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/Bigote93',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
      ...
      <div className="mx-auto max-w-full  py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-base font-medium text-gray-900">RappidEva</h3>
                <ul role="list" className="mt-4 space-y-4">
              ...
              <div className="mt-12 md:mt-0">
                <h3 className="text-base font-medium text-gray-900">Reglamentos</h3>
                <ul role="list" className="mt-4 space-y-4">
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 xl:text-center">&copy; 2023 RappidEva, Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
